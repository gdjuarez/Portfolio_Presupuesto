/*DNI a Cuil*/
var text = document.getElementById("dni");
var sex = document.getElementById("sel1");
var boton = document.getElementById("boton_aceptar");
boton.addEventListener("click", get_cuil_cuit);

function get_cuil_cuit(){
    var document_number = text.value;
    ...
    //asigno en el input text l valor
    document.getElementById("cuil").value=cuil_cuit;

    document.getElementById("codProveedor").value=cuil_cuit;
    //alert("Tu cuit- cuil es: " + cuil_cuit);
    return cuil_cuit;
}