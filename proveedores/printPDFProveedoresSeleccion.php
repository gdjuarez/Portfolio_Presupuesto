...
//$miconsulta="SELECT * FROM proveedor WHERE Apellido LIKE '$search%' order by Apellido ASC";

//$miconsulta=("SELECT * FROM proveedor WHERE Apellido LIKE 'ju%' order by Apellido ASC");


$proveedores = mysqli_query($miConexion,"SELECT * FROM proveedor WHERE Apellido LIKE '%$search%' or RazonSocial LIKE '%$search%'  or codProveedor LIKE '%$search%' order by Apellido ASC");
