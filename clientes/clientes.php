		...
		<div id="estilo" ; class="card card-body" ;>
			<div class="text-center">
				<form action="save.php" method="POST">
					<div class="form-row">
						<div class="col-6">
							<p>Codigo Cliente( Cuil/Cuit ):<input type="text" name="codCliente" id="codCliente" class="form-control" value="<?php echo $codCliente ?>" maxlength="11" required></p>
						</div>
						<div class="col-6">
					...
					<div class="text-center">
						<input type="submit" name="submit" value="Guardar" class="btn btn-primary mb-2" title="Registrar nuevo cliente" />
					</div>
				</form>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-6">
							<form action="" method="post" name="search_form" id="search_form">
								<input title="Ingrese cliente" type="text" name="search" id="search" placeholder="Ingrese cliente">
							</form>
						</div>
						<div class="col-md-6">
							<div class="text-right ">
								<div class="btn-group">
									<form action="printPDFClientesSeleccion.php" method="POST" target="ventanaForm" onsubmit="window.open('', 'ventanaForm', 'width=900, height=900')">
									...
									<form action="printPDFClientesTodos.php" method="POST" target="ventanaForm" onsubmit="window.open('', 'ventanaForm', 'width=900, height=900')">
