...
$sql = mysqli_query($miConexion,"SELECT *  FROM clientes order by Apellido");
...
<head>
  ...
  <a href="#" class="navbar-brand"><h2>Listado de Clientes</h2></a>
       ...
       <button class="btn btn-outline-danger sm" type="submit">usuario: <?php echo $_SESSION['user']?> <br>cerrar-sesion</button>
		...
		<div class='container'>
			<div class='row align-items-center'>
				...
				<div class="col-md-10">
				 		<form action="frmclientes.php" method="POST">
							<?php
							echo $dyn_table;
			...
			<div class='row'>
				...
				<div class="col-md-10">
					<div class="Imprimir p-2">
					   <form action="printPDFClientes.php" method="POST" target="ventanaForm" onsubmit="window.open('', 'ventanaForm', 'width=800, height=900')"  >
